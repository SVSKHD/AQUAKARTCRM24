...
// Define prop types for AquaDialog
...
const AquaDialog: React.FC<AquaDialogProps> = ({
  isOpen,
  setOpen,
        ...
        <div className="flex min-h-full items-end justify-center p-4 text-center sm:items-center sm:p-0">
          ...
          >
            ...
            <div className="mt-5 sm:mt-6 sm:grid sm:grid-flow-row-dense sm:grid-cols-2 sm:gap-3">
              <button
                type="button"
                onClick={primaryButtonAction || (() => setOpen(false))}
              ...
              <button
                type="button"
                onClick={secondaryButtonAction || (() => setOpen(false))}
